...
Server.prototype._process = function (input, req, callback) {
  ...
  try {
    if (binding.style === 'rpc') {
      ...
      if (!pair && binding.topElements && binding.topElements.hasOwnProperty(messageElemName + 'Request')) {
        messageElemName += 'Request';
        pair = binding.topElements[messageElemName];
      }
...
Server.prototype._envelope = function (body, headers, includeTimestamp) {
  ...
  var xml;
  if (!this.wsdl.options.skipXmlDeclaration) {
